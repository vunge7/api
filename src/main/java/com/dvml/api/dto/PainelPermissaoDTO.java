...
public class PainelPermissaoDTO {
    ...
    public LocalDateTime getDataActualizacao() { return dataActualizacao; }
    public Long getUsuarioIdCriacao() { return usuarioIdCriacao; }
    ...
    public void setDataActualizacao(LocalDateTime dataActualizacao) { this.dataActualizacao = dataActualizacao; }
    public void setUsuarioIdCriacao(Long usuarioIdCriacao) { this.usuarioIdCriacao = usuarioIdCriacao; }

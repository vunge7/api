...
public class UnidadeMedidaService {
    ...
    public UnidadeMedidas criar(UnidadeMedidas unidadeMedidas) {
        return repo.save(unidadeMedidas); // empresaId será salvo se preenchido
    }
    ...
    public ResponseEntity<String> update(UnidadeMedidas unidadeMedidas){
        ...
        unidadeMedidasToUpdate.setEmpresaId(unidadeMedidas.getEmpresaId()); // <--- empresaId adicionado
